  ...
  return (
    <section className="relative z-20 -mt-28 px-4 pb-12 pt-0 md:-mt-28 md:px-8 md:pb-16 lg:-mt-32">
      <div className="mx-auto max-w-7xl">
        <div className="overflow-hidden rounded-[2.25rem] border border-accent/28 bg-ink text-stone-50 shadow-[0_42px_110px_-72px_rgba(14,92,63,0.88)]">
          <div className="grid lg:grid-cols-[0.78fr_1.22fr]">
            <div className="relative isolate min-h-[20rem] overflow-hidden border-b border-white/10 p-7 md:p-10 lg:border-b-0 lg:border-r">
              <div className="absolute inset-0 -z-20 bg-[radial-gradient(circle_at_18%_12%,rgba(198,241,53,0.18),transparent_30rem),linear-gradient(135deg,rgba(245,240,231,0.08),transparent_45%)]" />
              <div className="absolute bottom-0 left-0 -z-10 h-28 w-full bg-[linear-gradient(180deg,transparent,rgba(31,168,106,0.18))]" />
            ...
            <div className="grid sm:grid-cols-2">
              {trustItems.map(([title, text], index) => (
                ...
                >
                  <div className="absolute inset-x-7 top-0 h-px bg-[linear-gradient(90deg,rgba(198,241,53,0.62),transparent)] opacity-0 transition duration-500 ease-luxury group-hover:opacity-100" />
                  <div className="flex items-start justify-between gap-6">
                    <p className="text-xs font-bold uppercase tracking-[0.24em] text-accent">0{index + 1}</p>
                    <span className="mt-1 h-2 w-2 rounded-full bg-accent/70 shadow-[0_0_0_6px_rgba(198,241,53,0.08)]" />
                  </div>
